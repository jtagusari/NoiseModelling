...
public class AcousticPath {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(AcousticPath.class);
    ...
    private void updateWithSegmentIndex(int segmentIndex) {
        ...
        LOGGER.debug("updateWithSegmentIndex: segmentIndex={}, pivotPointsSize={}", 
                    segmentIndex, pivotPointCoordinates.size());
        ...
        if (pivotPointCoordinates.size() == 2) {
            ...
            LOGGER.debug("Segment {} - isFinalSegment={}, isUpperEdgeSegment={}, pivotType={}", 
                        segmentIndex, isFinalSegment, isUpperEdgeSegment, 
                        horizontalEdgePivotPoints.get(segmentIndex).getPivotType());
    ...
    private void addSourcePoint() {
        ...
        LOGGER.debug("Added SOURCE point at ({}, {}, {})", 
                    sourcePoint.coordinate.x, sourcePoint.coordinate.y, sourcePoint.coordinate.z);
    }
    ...
    private void addReceiverPoint() {
        ...
        LOGGER.debug("Added RECEIVER point at ({}, {}, {})", 
                    receiverPoint.coordinate.x, receiverPoint.coordinate.y, receiverPoint.coordinate.z);
        return;
    }
    ...
    private void addHorizontalEdgeDiffractionPoint() {        
        ...
        LOGGER.debug("Added DIFH (horizontal diffraction) point at ({}, {}, {})", 
                    diffractionPoint.coordinate.x, diffractionPoint.coordinate.y, diffractionPoint.coordinate.z);
        return;
    }
    ...
    private void addUpperHorizontalEdgeDiffractionPoint() {        
        ...
        LOGGER.debug("Added DIFB (bottom of obstacle/upper horizontal edge diffraction) point at ({}, {}, {})", 
                    diffractionPoint.coordinate.x, diffractionPoint.coordinate.y, diffractionPoint.coordinate.z);
        return;
    }
