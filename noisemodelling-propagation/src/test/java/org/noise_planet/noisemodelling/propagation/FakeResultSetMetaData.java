...
/** Minimal ResultSetMetaData implementation for tests. */
public class FakeResultSetMetaData implements ResultSetMetaData {
    private final String[] columns;

    public FakeResultSetMetaData(String[] columns) {
    ...
    // --- Unused methods of ResultSetMetaData below are left unimplemented ---
    @Override public String getCatalogName(int column) throws SQLException { return null; }
    @Override public String getColumnClassName(int column) throws SQLException { return null; }
    ...
    @Override public String getColumnTypeName(int column) throws SQLException { return null; }
