...
def exec(Connection connection, Map input) {
    ...
    String tableRoadsTraffic = ""
    if (input['tableRoadsTraffic']) {
        // Use the right default database caps according to db type
        tableRoadsTraffic = TableLocation.capsIdentifier(input['tableRoadsTraffic'] as String, dbType)
    }
    ...
    EmissionInputSettings emissionInputSettings = new EmissionInputSettings.Builder()
        .setSourcesEmissionTableName(tableRoadsTraffic)
